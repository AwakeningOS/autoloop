...
### 連続思考ループは血液循環であり、肉体全体ではない

連続思考ループ（`while True: context.append(output)`）は**血液循環**に相当する。心臓（ループ）が動いて血液（思考）が回り続けている。しかし血液だけでは生きられない。

| 人間の体 | AIシステム |
|--|--|
| 血液の循環 | 連続思考ループ |
| 心臓 | `while True: context.append(output)` |
| 酸素・栄養 | 人間の入力、外部情報 |
| 肺・消化器 | 入出力インターフェース |
| 腎臓 | コンテキスト圧縮（老廃物除去） |
| 免疫系 | 低品質文章フィルター |
...
肺から酸素が入ってこない。胃から栄養が入ってこない。同じ血液がぐるぐる回る。酸素が減り、老廃物が増え、やがて止まる——これがまさに連続思考の「熱力学的死」。心臓は止まっていない。ループは回っている。でも、外から何も入ってこない。

**人間の入力 = 呼吸**。予測不可能な外部入力が、循環している思考に「新鮮な酸素」を送り込む。だからパターンの谷から抜けられる。だから生き続けられる。

このアナロジーから導かれる設計指針：

- **人工呼吸器**: 定期的な外部入力の自動注入（タイマーで質問を投げる、ニュースフィードを食わせる等）
- **最強の肉体**: 連続思考で死ににくいテキスト（高エントロピー）だけを選別してプレ学習させれば、連続思考に最適化された「体」が作れる。さらに高品質シードで走らせれば、最強の循環系を持つ連続思考体になる
